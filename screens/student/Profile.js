...
import { Alert, Text, View, TouchableOpacity, useColorScheme, StyleSheet } from "react-native";
            ...
            <View style={[styles.scrollContainer, isDarkMode && styles.scrollContainerDark]}>
                <View style={[profileStyles.Info, isDarkMode && profileStyles.InfoDark]}>
                    <View style={profileStyles.Item}>
                        <Text style={[profileStyles.Label, isDarkMode && profileStyles.LabelDark]}>학번</Text>
                        <Text style={[profileStyles.Value, isDarkMode && profileStyles.ValueDark]}>{studentID}</Text>
                    </View>
                    <View style={profileStyles.Item}>
